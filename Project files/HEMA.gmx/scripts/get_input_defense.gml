...
if(!disable_input)
{
    ...
    if(Score_defense.allow_block)
    {
        block = keyboard_check(ord('C'));
    }
    if(Score_defense.allow_attack)
    {
        attack = keyboard_check_pressed(ord('V'));
    }
    if(Score_defense.allow_attack_block)
    {
    ...
    if(Score_defense.allow_counter)
    {
